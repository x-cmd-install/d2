...
合计: **2,109,847** 行代码（覆盖前 5 种语言、共 **4164** 个文件）。
...
- **Star**: 25,380 · **Fork**: 747 · **开放 issue**: 1,396 · **贡献者**: 66

## 累计统计

- **发布数**: 36 · **已合并 PR**: 1139 · **开放 PR**: 58 · **已关闭 issue**: 922 · **开放 issue**: 474 · **提交数**: 5326
...
在 [repology.org](https://repology.org/project/d2) 上共有 **27** 个发行版报告此项目。**8** 个 ✅ 已是最新上游版本，**17** 个 ⚠️ 使用旧版本。
...
_数据快照: `data/card/260911.yml` · 2026-09-11T19:38:27Z._
